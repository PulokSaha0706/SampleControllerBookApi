...
import (
	...
	scheme "github.com/PulokSaha0706/my-controller/pkg/generated/clientset/versioned/scheme"
...
func newKlusters(c *PulokdevV1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
